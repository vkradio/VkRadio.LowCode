...
{
    public MsSqlValueField(TableAndEntityCorrespondence tableAndEntityCorrespondence, PropertyDefinition propertyDefinition)
    ...
    protected override void SetupUniqueCodeField(PropertyDefinition propertyDefinition)
    {
        ...
        _sqlType = MsSqlForeignKeyField.C_SQL_TYPE;
