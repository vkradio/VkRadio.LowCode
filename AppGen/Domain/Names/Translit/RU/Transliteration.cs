namespace VkRadio.LowCode.AppGen.Domain.Names.Translit.RU;
...
public static class Transliteration
{
    ...
    private static readonly Dictionary<string, string> gost = []; // GOST 16876-71
    private static readonly Dictionary<string, string> iso = []; // ISO 9-95
