...
public class FieldPropertyHelper
{
    ...
    )
    {
        ...
        else
        {
            ...
            {
                throw new GeneratorException($"Not recognized FunctionalType of PropertyDefinition {propDef.Id} {propDef.Names[NaturalLanguageEnum.En]}: {propDef.FunctionalType.GetType().Name}.");
            }
        }
    }
}
