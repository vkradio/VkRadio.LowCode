...
{
    public class CardResourceComponent: ComponentWPredefinedCode
    {
        public CardResourceComponent(PackNS.Package in_package, string in_componentName)
        {
            _emitUtf8Bom = true;
            _lastLineWNewLine = false;
            Package = in_package;
            Name = in_componentName;
