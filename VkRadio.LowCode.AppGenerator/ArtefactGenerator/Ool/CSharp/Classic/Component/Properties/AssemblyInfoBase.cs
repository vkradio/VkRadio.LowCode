...
namespace ArtefactGenerationProject.ArtefactGenerator.Ool.CSharp.Classic.Component.Properties
{
    ...
    {
        public AssemblyInfoBase(PropertiesPackageBase in_package)
            : base(in_package)
        {
            var cSharpAppTarget = in_package.ParentPackage.ParentPackage.ArtefactGenerationTarget.Parent;
            ...
            _predefinedCode.Add($"[assembly: AssemblyTitle(\"{in_package.ParentPackage.RootNamespace}\")]");
            ...
            _predefinedCode.Add($"[assembly: AssemblyProduct(\"{in_package.ParentPackage.RootNamespace}\")]");
