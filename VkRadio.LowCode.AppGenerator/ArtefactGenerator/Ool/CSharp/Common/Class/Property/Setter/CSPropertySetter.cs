...
namespace ArtefactGenerationProject.ArtefactGenerator.Ool.CSharp.Common.Class.Property.Setter
{
    public class CSPropertySetter
    {
        ...
        public CSPropertySetter(CSProperty property) : this(property, true, true) {}
        ...
        protected virtual string[] GenerateLinesSetValue() =>
            new string[] { $"{Property.NameFieldCorresponding} = value;" };
