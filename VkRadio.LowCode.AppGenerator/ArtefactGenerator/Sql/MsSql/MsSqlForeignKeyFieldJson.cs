...
{
    class MsSqlForeignKeyFieldJson: ForeignKeyFieldJson, IMsSqlConstraint
    {
        ...
        public MsSqlForeignKeyFieldJson(TableAndDOTCorrespondenceJson in_tableAndDOTCorrespondence, PropertyDefinition in_propertyDefinition)
