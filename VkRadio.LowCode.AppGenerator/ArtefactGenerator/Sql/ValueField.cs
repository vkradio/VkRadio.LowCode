...
namespace ArtefactGenerationProject.ArtefactGenerator.Sql
{
    ...
    public abstract class ValueField : ITableField
    {
        ...
        public ValueField(TableAndDOTCorrespondence in_tableAndDOTCorrespondence, PropertyDefinition in_propertyDefinition)
        {
            ...
            _dotPropertyCorrespondence = new PropertyCorrespondence { PropertyDefinition = in_propertyDefinition, TableField = this, TableAndDOTCorrespondence = in_tableAndDOTCorrespondence };
        }
        public void Init()
        {
