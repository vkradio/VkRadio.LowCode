...
public class ArtefactGenerationProject : IUnique
{
    ...
    /// MetaModel
    /// </summary>
    public MetaModel.MetaModel MetaModel { get; private set; } = default!;
    /// <summary>
    /// Targets of artefact generation
    /// </summary>
    public List<ArtefactGenerationTarget> Targets { get; private set; }
    /// <summary>
    /// Project root path
    /// </summary>
    ...
    //    var project = new ArtefactGeneratorProject
    //    {
    //        Id = id,
    //        Name = name,
    //        MetaModel = metaModel,
    ...
    //    {
    //        project.Targets.Add(ArtefactGenerationTarget.LoadFromXElement(project, xel));
    //    }

    //    // Deferred linking of target dependencies
    //    foreach (var tgt in project.Targets)
    //    {
    //        tgt.DeferredLinkDependencies(project.Targets);
    //    }
