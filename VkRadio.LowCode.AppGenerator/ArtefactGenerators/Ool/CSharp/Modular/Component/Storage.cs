...
{
    static List<CSClassConstant> GenerateFieldConstants(TableAndDOTCorrespondence tableAndDotCorrespondence, CSClass storageClass, List<int> decimalConstants)
    {
    ...
    private static void GenerateRestoreByNameMethod(CSClass storageClass, string dotClassName, TableAndDOTCorrespondence tableAndDotCorrespondence)
    {
