...
public class PropertyDefinition : IUniqueNamed, IPropertyDefinition
{
    ...
    EntityDefinition _ownerDefinition;
    ...
    /// <summary>
    /// Entity type definition that owns this property
    /// </summary>
    public EntityDefinition OwnerDefinition { get => _ownerDefinition; set { _ownerDefinition = value; } }

    /// <summary>
    /// Functional type of a property
    /// </summary>
    public PropertyFunctionalType FunctionalType => _functionalType;
    ...
    public static PropertyDefinition LoadFromXElement(XElement containingXel, DomainModel metaModel)
    {
