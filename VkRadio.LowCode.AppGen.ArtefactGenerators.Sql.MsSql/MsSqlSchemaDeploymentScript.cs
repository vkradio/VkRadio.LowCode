...
{
    public MsSqlSchemaDeploymentScript(DBSchemaDomainModel dbSchemaDomainModel)
        : base(dbSchemaDomainModel)
        => _quoteSymbol = "\"";

    public override string[] Generate()
    {
        var target = _dbSchemaDomainModel.ArtefactGeneratorSql.Target;
        var project = target.Project;
        var generator = _dbSchemaDomainModel.ArtefactGeneratorSql;
